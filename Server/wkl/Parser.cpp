...
Node* parse(Lexer* lexer){
	...
	Node* result, *arg0, *arg1, *arg2, *arg3;
	goto START;
	/*** States ****/
Shift0:
/*
...
State0:
	...
	switch(current_terminal->token()){
		case TOKEN_newline: goto Shift79;
		case TOKEN_error: goto Shift77;
...
Goto0:
	switch(top_non_terminal){
		case SYMBOL_program: goto State81;
		case SYMBOL_top_defs: goto State78;
		case SYMBOL_top_def: goto State75;
		case SYMBOL_method: goto State74;
		case SYMBOL_error:
			goto Shift77;
...
Goto11:
	switch(top_non_terminal){
		case SYMBOL_block: goto State73;
		case SYMBOL_error:
			states.pop();
			symbols.pop();
			goto *states.top();
...
State12:
	states.push(&&Goto12);
	switch(current_terminal->token()){
		case TOKEN_if: goto Shift24;
		case TOKEN_while: goto Shift14;
		case TOKEN_out: goto Shift58;
		case TOKEN_in: goto Shift53;
		case TOKEN_return: goto Shift50;
		case TOKEN_left_p: goto Shift39;
		case TOKEN_int: goto Shift13;
		case TOKEN_id: goto Shift70;
		default: goto ERROR;
	}

Goto12:
	switch(top_non_terminal){
		case SYMBOL_stmts: goto State68;
		case SYMBOL_stmt: goto State65;
		case SYMBOL_closedStmt: goto State63;
		case SYMBOL_varDecl: goto State49;
		case SYMBOL_expr: goto State48;
		case SYMBOL_tuprefblock: goto State45;
		case SYMBOL_varexpr: goto State27;
		case SYMBOL_error:
			states.pop();
			symbols.pop();
			goto *states.top();
...
State15:
	states.push(&&Goto15);
	switch(current_terminal->token()){
		case TOKEN_minus: goto Shift18;
		case TOKEN_plus: goto Shift16;
		case TOKEN_dot: goto Shift20;
		case TOKEN_left_c: goto Shift12;
		default: goto ERROR;
	}
...
State19:
	states.push(&&Goto19);
	switch(current_terminal->token()){
		case TOKEN_left_c: goto Reduce48;
		case TOKEN_plus: goto Reduce48;
		case TOKEN_minus: goto Reduce48;
		case TOKEN_right_p: goto Reduce48;
		case TOKEN_comma: goto Reduce48;
		case TOKEN_semicolon: goto Reduce48;
		case TOKEN_dot: goto Shift20;
		default: goto ERROR;
	}
...
Goto25:
	switch(top_non_terminal){
		case SYMBOL_block: goto State26;
		case SYMBOL_error:
			states.pop();
			symbols.pop();
			goto *states.top();
...
State27:
	...
	switch(current_terminal->token()){
		...
		case TOKEN_assignment: goto Shift37;
		case TOKEN_left_p: goto Shift29;
		default: goto ERROR;
	}

Goto27:
	switch(top_non_terminal){
		case SYMBOL_argblock: goto State28;
		case SYMBOL_error:
			states.pop();
			symbols.pop();
			goto *states.top();
...
State29:
	states.push(&&Goto29);
	switch(current_terminal->token()){
		case TOKEN_right_p: goto Shift35;
		case TOKEN_int: goto Shift13;
		case TOKEN_id: goto Shift23;
		default: goto ERROR;
	}
...
Goto29:
	switch(top_non_terminal){
		case SYMBOL_expr: goto State36;
		case SYMBOL_varexpr: goto State27;
		case SYMBOL_args: goto State33;
		case SYMBOL_arg: goto State30;
		case SYMBOL_error:
			states.pop();
			symbols.pop();
			goto *states.top();
...
State36:
	...
	switch(current_terminal->token()){
		...
		case TOKEN_comma: goto Reduce39;
		case TOKEN_minus: goto Shift18;
		case TOKEN_plus: goto Shift16;
		case TOKEN_dot: goto Shift20;
		default: goto ERROR;
...
State39:
	states.push(&&Goto39);
	switch(current_terminal->token()){
		case TOKEN_id: goto Shift44;
		default: goto ERROR;
	}

Goto39:
	switch(top_non_terminal){
		case SYMBOL_tuprefs: goto State40;
		case SYMBOL_error:
			states.pop();
			symbols.pop();
			goto *states.top();
...
State40:
	states.push(&&Goto40);
	switch(current_terminal->token()){
		case TOKEN_right_p: goto Shift43;
...
Goto41:
	switch(top_non_terminal){
		case SYMBOL_tuprefs: goto State42;
		case SYMBOL_error:
			states.pop();
			symbols.pop();
			goto *states.top();
...
State42:
	...
	switch(current_terminal->token()){
		...
		case TOKEN_comma: goto Reduce46;
		default: goto ERROR;
	}
...
State43:
	states.push(&&Goto43);
	switch(current_terminal->token()){
		case TOKEN_assignment: goto Reduce45;
		default: goto ERROR;
	}
...
State45:
	states.push(&&Goto45);
	switch(current_terminal->token()){
		case TOKEN_assignment: goto Shift46;
		default: goto ERROR;
	}
...
Goto50:
	switch(top_non_terminal){
		case SYMBOL_returnStmt: goto State52;
		case SYMBOL_expr: goto State51;
		case SYMBOL_varexpr: goto State27;
		case SYMBOL_error:
			states.pop();
			symbols.pop();
...
Goto53:
	switch(top_non_terminal){
		case SYMBOL_inDecl: goto State54;
		case SYMBOL_error:
			states.pop();
			symbols.pop();
			goto *states.top();
...
Goto55:
	switch(top_non_terminal){
		case SYMBOL_inDecl: goto State56;
		case SYMBOL_error:
			states.pop();
			symbols.pop();
			goto *states.top();
...
State58:
	states.push(&&Goto58);
	switch(current_terminal->token()){
		case TOKEN_id: goto Shift60;
		default: goto ERROR;
	}

Goto58:
	switch(top_non_terminal){
		case SYMBOL_outDecl: goto State59;
		case SYMBOL_error:
			states.pop();
			symbols.pop();
			goto *states.top();
...
State60:
	states.push(&&Goto60);
	switch(current_terminal->token()){
		case TOKEN_assignment: goto Shift61;
		default: goto ERROR;
	}
...
Goto63:
	switch(top_non_terminal){
		case SYMBOL_stmts: goto State64;
		case SYMBOL_stmt: goto State65;
		case SYMBOL_closedStmt: goto State63;
		case SYMBOL_varDecl: goto State49;
		case SYMBOL_expr: goto State48;
...
State65:
	states.push(&&Goto65);
	switch(current_terminal->token()){
		case TOKEN_semicolon: goto Shift66;
		default: goto ERROR;
	}
...
Goto66:
	switch(top_non_terminal){
		case SYMBOL_stmts: goto State67;
		case SYMBOL_stmt: goto State65;
		case SYMBOL_closedStmt: goto State63;
		case SYMBOL_varDecl: goto State49;
		case SYMBOL_expr: goto State48;
...
State68:
	states.push(&&Goto68);
	switch(current_terminal->token()){
		case TOKEN_right_c: goto Shift69;
		default: goto ERROR;
	}
...
State70:
	...
	switch(current_terminal->token()){
		...
		case TOKEN_assignment: goto Shift71;
		default: goto ERROR;
	}
...
Goto75:
	switch(top_non_terminal){
		case SYMBOL_top_defs: goto State76;
		case SYMBOL_top_def: goto State75;
		case SYMBOL_method: goto State74;
		case SYMBOL_error:
			states.pop();
...
Goto79:
	switch(top_non_terminal){
		case SYMBOL_top_defs: goto State80;
		case SYMBOL_top_def: goto State75;
		case SYMBOL_method: goto State74;
		case SYMBOL_error:
			states.pop();
...
Reduce32: //closedStmt -> [if] expr block
	...
	result = NULL;
	{
	cerr<<"PARSE closedStmt"<<endl; result = new NodeIfStmt((NodeExpr*)arg1, (NodeStmt*)arg2, NULL, NULL);
	}
	symbols.push(result);
...
Reduce33: //closedStmt -> [while] expr block
	...
	result = NULL;
	{
	cerr<<"PARSE closedStmt"<<endl; result = new NodeWhileStmt((NodeExpr*)arg1, (NodeStmt*)arg2, NULL);
	}
	symbols.push(result);
	top_non_terminal = SYMBOL_closedStmt;
	goto *states.top();
...
Reduce35: //argblock -> [left_p] args [right_p]
	delete symbols.top();
	symbols.pop();
	states.pop();
	arg1 = symbols.top();
...
Reduce36: //argblock -> [left_p] [right_p]
	delete symbols.top();
	symbols.pop();
	states.pop();
	delete symbols.top();
...
Reduce40: //tupblock -> [left_p] tups [right_p]
	delete symbols.top();
	symbols.pop();
	states.pop();
	arg1 = symbols.top();
...
Reduce41: //tupblock -> [left_p] [right_p]
	delete symbols.top();
	symbols.pop();
	states.pop();
	delete symbols.top();
...
Reduce45: //tuprefblock -> [left_p] tuprefs [right_p]
	delete symbols.top();
	symbols.pop();
	states.pop();
	arg1 = symbols.top();
...
Reduce46: //tuprefs -> tuprefs [comma] tuprefs
	arg2 = symbols.top();
	symbols.pop();
	states.pop();
	delete symbols.top();
...
Reduce51: //expr -> varexpr argblock
	arg1 = symbols.top();
	symbols.pop();
	states.pop();
	arg0 = symbols.top();
...
Reduce53: //expr -> varexpr [assignment] expr
	arg2 = symbols.top();
	symbols.pop();
	states.pop();
	delete symbols.top();
